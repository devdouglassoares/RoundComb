...
namespace System.Linq.Dynamic
{
    ...
    internal class ExpressionParser
    {
        ...
        private static readonly Type[] predefinedTypes = new Type[] {
            ...
            typeof(TimeSpan), typeof(Guid), typeof(Math), typeof(Convert), typeof(EntityFunctions), typeof(SqlFunctions)
         };
        ...
        private static int CompareConversions(Type s, Type t1, Type t2)
        {
            if (t1 != t2)
            {
                ...
                if ((t1 == typeof(decimal?)) && (t2 == typeof(double?)))
                {
                    return 1;
                }
            }
        ...
        private Expression ParseNew()
        {
            ...
            while (true)
            {
                ...
                if (this.token.id != TokenId.Comma)
                {
                    this.ValidateToken(TokenId.CloseParen, "')' or ',' expected");
                    this.NextToken();
                    Type type = System.Linq.Dynamic.DynamicExpression.CreateClass(properties);
